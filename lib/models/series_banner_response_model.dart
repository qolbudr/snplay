...
class SeriesBannerResponseModel {
  String? id;
  String? tMDBID;
  String? name;
  String? description;
  ...
  SeriesBannerResponseModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    tMDBID = json['TMDB_ID'];
    name = json['name'];
  ...
  SeriesBanner toEntity() => SeriesBanner(id: id, name: name, banner: banner);
}
